...
from ...tests.mixins import TelegramBotMixin, TemporaryVariableMixin
from ..views import TemporaryVariableViewSet
...
class TemporaryVariableViewSetTests(
    ...
    def setUp(self) -> None:
        ...
        self.list_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-temporary-variable-list',
        ...
        self.detail_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-temporary-variable-detail',
            kwargs={
