...
from ...tests.mixins import RandomizerMixin, TelegramBotMixin
...
class RandomizerViewSetTests(
    RandomizerMixin, HubMixin, TelegramBotMixin, UserMixin, TestCase
):
    def setUp(self) -> None:
        super().setUp()
        ...
        self.list_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-randomizer-list',
        ...
        self.detail_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-randomizer-detail',
            kwargs={
