...
from ...tests.mixins import TelegramBotMixin, TimerMixin
...
class TimerViewSetTests(TimerMixin, HubMixin, TelegramBotMixin, UserMixin, TestCase):
    def setUp(self) -> None:
        super().setUp()
        ...
        self.list_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-timer-list',
        ...
        self.detail_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-timer-detail',
            kwargs={
