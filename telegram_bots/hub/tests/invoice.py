...
from ...tests.mixins import InvoiceMixin, TelegramBotMixin
...
class InvoiceViewSetTests(
    ...
    def setUp(self) -> None:
        ...
        self.list_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-invoice-list',
        ...
        self.detail_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-invoice-detail',
