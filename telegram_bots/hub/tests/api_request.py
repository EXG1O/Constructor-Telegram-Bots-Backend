...
from ...tests.mixins import APIRequestMixin, TelegramBotMixin
...
class APIRequestViewSetTests(
    ...
    def setUp(self) -> None:
        ...
        self.list_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-api-request-list',
        ...
        self.detail_true_url: str = reverse(
            'api:telegram-bots-hub:telegram-bot-api-request-detail',
            kwargs={
